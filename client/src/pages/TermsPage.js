        ...
        <Box>
          ...
          <Section title="4. Prohibited Conduct">
            ...
            <List sx={{ listStyleType: 'disc', pl: 4 }}>
              <ListItem sx={{ display: 'list-item', p: 0, pb: 1 }}><Typography component="span" sx={{ fontFamily: theme.typography.fontFamily }}>Violate any local, state, national, or international law.</Typography></ListItem>
              <ListItem sx={{ display: 'list-item', p: 0, pb: 1 }}><Typography component="span" sx={{ fontFamily: theme.typography.fontFamily }}>Engage in any activity that is harmful, fraudulent, deceptive, or harassing.</Typography></ListItem>
              <ListItem sx={{ display: 'list-item', p: 0, pb: 1 }}><Typography component="span" sx={{ fontFamily: theme.typography.fontFamily }}>Attempt to gain unauthorized access to any portion of the Service or any other systems or networks.</Typography></ListItem>
              <ListItem sx={{ display: 'list-item', p: 0 }}><Typography component="span" sx={{ fontFamily: theme.typography.fontFamily }}>Interfere with or disrupt the integrity or performance of the Service.</Typography></ListItem>
            </List>
          </Section>
